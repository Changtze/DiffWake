...
class Real(Domain):
    ...
    def __init__(self, lower, upper):
        ...
        super().__init__(dtype=jax.numpy.float64)
...
class Integer(Domain):
    ...
    def transform(self, x: jax.Array):
        ...
        Returns:
            Rounded and clipped values as float64.
        """
        return jax.numpy.clip(jax.numpy.round(x), self.lower, self.upper).astype(jax.numpy.float64)
